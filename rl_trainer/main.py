...
def main(args):
    ...
    # 定义保存路径
    run_dir, log_dir = make_logpath('snake_3v3', args.algo)
    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            next_state, reward, done, info = env.step(env.encode(actions))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_episodes', default=400, type=int) #训练达到几个episode
    parser.add_argument('--episode_length', default=0, type=int) #从第几个episode之后开始打印奖励信息
    ...
    parser.add_argument('--a_lr', default=0.0001, type=float) #actor的学习率
    parser.add_argument('--c_lr', default=0.0001, type=float) #评论家的学习率
    parser.add_argument('--batch_size', default=64, type=int)
    parser.add_argument('--epsilon', default=0.5, type=float)
    parser.add_argument('--epsilon_speed', default=0.99998, type=float)

    parser.add_argument("--save_interval", default=5, type=int) #几个episode保存一次
    ...
    parser.add_argument("--load_model_run_episode", default=5, type=int)
